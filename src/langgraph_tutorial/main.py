...
researcher_node = partial(
    generic_node, init_agent=init_researcher_agent, agent_name="Researcher"
)
creator_node = partial(
    generic_node, init_agent=init_creator_agent, agent_name="Creator"
)
supervisor_node = partial(
    generic_node, init_agent=init_supervisor_agent, agent_name="Supervisor"
)
...
workflow_builder.add_conditional_edges(
    "supervisor", supervisor_routing, ["researcher", "creator", END]
)
